    ...
    */
    ...
    public function run()
    {
        ...
        */
        ...
        // truncate 3 tables before seeding
        ...
        $this->beginDropdown('admin', 'Settings', 'cil-calculator');
            ...
            $this->insertLink('admin', 'Games',                   '/users');
            $this->insertLink('admin', 'Leagues',                 '/leagues');
            $this->insertLink('admin', 'Teams',                   '/teams');
            $this->insertLink('admin', 'Players',                 '/players');
