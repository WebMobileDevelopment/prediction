 ...
 */
 ...
 (function($) {
     /*Prefetch Owl Images*/
     ! function(t, e, o, i) { var r = function(e) { this._core = e, this._loaded = [], this._handlers = { "initialized.owl.carousel change.owl.carousel": t.proxy(function(e) { if (e.namespace && this._core.settings && !1 !== this._core.settings.lazyLoad && (e.property && "position" === e.property.name || "initialized" === e.type)) { var o = e.property && e.property.value || this._core.current(),
                             i = this.positions(o),
                             r = this._core.clones().length,
                             s = i.length,
                             n = t.proxy(function(t, e) { this.load(e) }, this); for (console.log(); s--;) this.load(r / 2 + i[s]), r && t.each(this._core.clones(i[s]), n) } }, this) }, this._core.options = t.extend({}, r.Defaults, this._core.options), this._core.$element.on(this._handlers) };
         r.Defaults = { lazyLoad: !1, lazyPrefetch: "page" }, r.prototype.positions = function(t) { for (var e = [], o = this._core.settings, i = this._core.relative(t), r = o.loop || o.center && i > 0, s = o.center && (i > 0 || o.loop), n = o.items + (s && o.items % 2 == 0 ? 1 : 0), a = "page" === o.lazyPrefetch ? n : o.lazyPrefetch, l = n, c = s ? -Math.ceil(o.items / 2) : 0; a--;) r && e.unshift(this._core.relative(t - a + c - 1)), e.unshift(this._core.relative(t + n + a + c)); for (; l--;) e.unshift(this._core.relative(t + l + c)); return e }, r.prototype.load = function(o) { var i = this._core.$stage.children().eq(o),
                 r = i && i.find(".owl-lazy");!r || t.inArray(i.get(0), this._loaded) > -1 || (r.each(t.proxy(function(o, i) { var r = t(i),
                     s = e.devicePixelRatio > 1 && r.attr("data-src-retina") || r.attr("data-src");
                 this._core.trigger("load", { element: r, url: s }, "lazy"), r.is("img") ? r.one("load.owl.lazy", t.proxy(function() { r.css("opacity", 1), this._core.trigger("loaded", { element: r, url: s }, "lazy"), this._core.settings.autoWidth && (this._core.invalidate("width"), this._core.update()) }, this)).attr("src", s) : t(new Image).one("load.owl.lazy", t.proxy(function() { r.css({ "background-image": "url(" + s + ")", opacity: "1" }), this._core.trigger("loaded", { element: r, url: s }, "lazy") }, this)).attr("src", s) }, this)), this._loaded.push(i.get(0))) }, r.prototype.destroy = function() { var t, e; for (t in this.handlers) this._core.$element.off(t, this.handlers[t]); for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null) }, t.fn.owlCarousel.Constructor.Plugins.Lazy = r }(window.Zepto || window.jQuery, window, document);
 }(jQuery));

 (function($) {
     /*! Enabled Custom Plugin */
     ! function(t) { "use strict"; "object" == typeof module && "object" == typeof module.exports ? t(require("jquery"), window, document) : t(jQuery, window, document) }(function(b, C, E, P) { "use strict"; if (!C.history.pushState) return b.fn.smoothState = function() { return this }, void(b.fn.smoothState.options = {}); if (!b.fn.smoothState) { var T = b("html, body"),
                 O = C.console,
                 x = { isExternal: function(t) { var e = t.match(/^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/); return "string" == typeof e[1] && 0 < e[1].length && e[1].toLowerCase() !== C.location.protocol || "string" == typeof e[2] && 0 < e[2].length && e[2].replace(new RegExp(":(" + { "http:": 80, "https:": 443 }[C.location.protocol] + ")?$"), "") !== C.location.host }, stripHash: function(t) { return t.replace(/#.*/, "") }, isHash: function(t, e) { e = e || C.location.pathname; var n = 0 <= t.indexOf(e),
                             o = t.slice(t.indexOf(e) + e.length),
                             r = 0 < t.indexOf("#"); return ("" === o || 0 === o.indexOf("#")) && !(!n || !r) }, translate: function(t) { var e = { dataType: "html", type: "GET" }; return t = "string" == typeof t ? b.extend({}, e, { url: t }) : b.extend({}, e, t) }, shouldLoadAnchor: function(t, e, n) { var o = t.prop("href"); return !(x.isExternal(o) || x.isHash(o) || t.is(e) || t.prop("target") || typeof n !== P && "" !== n && -1 === t.prop("href").search(n)) }, clearIfOverCapacity: function(t, e) { return Object.keys || (Object.keys = function(t) { var e, n = []; for (e in t) Object.prototype.hasOwnProperty.call(t, e) && n.push(e); return n }), Object.keys(t).length > e && (t = {}), t }, storePageIn: function(t, e, n, o, r, a) { var i = b("<html></html>").append(b(n)); return void 0 === r && (r = {}), void 0 === a && (a = e), t[e] = { status: "loaded", title: i.find("title").first().text(), html: i.find("#" + o), doc: n, state: r, destUrl: a }, t }, triggerAllAnimationEndEvent: function(e, t) { t = " " + t || ""; var n = 0;
                         e.on("animationstart webkitAnimationStart oanimationstart MSAnimationStart", function(t) { b(t.delegateTarget).is(e) && (t.stopPropagation(), n++) }), e.on("animationend webkitAnimationEnd oanimationend MSAnimationEnd", function(t) { b(t.delegateTarget).is(e) && (t.stopPropagation(), 0 == --n && e.trigger("allanimationend")) }), e.on("allanimationend" + t, function() { n = 0, x.redraw(e) }) }, redraw: function(t) { t.height() } },
                 n = function(t, s) { var e, l = b(t),
                         c = l.prop("id"),
                         o = null,
                         r = !1,
                         u = {},
                         ...
                         h = function(t, e) { e = e || b.noop; var r = x.translate(t); if (!(u = x.clearIfOverCapacity(u, s.cacheLength)).hasOwnProperty(r.url) || void 0 !== r.data) { u[r.url] = { status: "fetching" }; var n = b.ajax(r);
                                 n.done(function(t) { x.storePageIn(u, r.url, t, c), l.data("smoothState").cache = u }), n.fail(function() { u[r.url].status = "error" }), s.locationHeader && n.always(function(t, e, n) { var o = (t.statusCode ? t : n).getResponseHeader(s.locationHeader);
                                     o && (u[r.url].destUrl = o) }), e && n.always(e) } },
                         p = function(t) { var e = "#" + c,
                                 n = u[t] ? b(u[t].html.html()) : null;
                             n.length ? (E.title = u[t].title, l.data("smoothState").href = t, s.loadingClass && T.removeClass(s.loadingClass), s.onReady.render(l, n), l.one("ss.onReadyEnd", function() { r = !1, s.onAfter(l, n), s.scroll && function() { if (o) { var t = b(o, l); if (t.length) { var e = t.offset().top;
                                             T.scrollTop(e) }
                                         o = null } }(), w(l) }), C.setTimeout(function() { l.trigger("ss.onReadyEnd") }, s.onReady.duration)) : !n && s.debug && O ? O.warn("No element with an id of " + e + " in response from " + t + " in " + u) : C.location = t },
                         a = function(t, n, o) { var r = x.translate(t);
                             void 0 === n && (n = !0), void 0 === o && (o = !0); var a = !1,
                                 i = !1,
                                 e = { loaded: function() { var t = a ? "ss.onProgressEnd" : "ss.onStartEnd"; if (i && a ? i && p(r.url) : l.one(t, function() { p(r.url), o || f(r.url) }), n) { var e = u[r.url].destUrl;
                                             d = s.alterChangeState({ id: c }, u[r.url].title, e), u[r.url].state = d, C.history.pushState(d, u[r.url].title, e) }
                                         i && !o && f(r.url) }, fetching: function() { a || (a = !0, l.one("ss.onStartEnd", function() { s.loadingClass && T.addClass(s.loadingClass), s.onProgress.render(l), C.setTimeout(function() { l.trigger("ss.onProgressEnd"), i = !0 }, s.onProgress.duration) })), C.setTimeout(function() { u.hasOwnProperty(r.url) && e[u[r.url].status]() }, 10) }, error: function() { s.debug && O ? O.log("There was an error loading: " + r.url) : C.location = r.url } };
                             u.hasOwnProperty(r.url) || h(r), s.onStart.render(l), C.setTimeout(function() { s.scroll && setTimeout(function() { T.scrollTop(0) }, 200), l.trigger("ss.onStartEnd") }, s.onStart.duration), e[u[r.url].status]() },
                         i = function(t) { var e, n = b(t.currentTarget);
                             x.shouldLoadAnchor(n, s.blacklist, s.hrefRegex) && !r && (t.stopPropagation(), e = x.translate(n.prop("href")), e = s.alterRequest(e), h(e)) },
                         g = function(t) { var e = b(t.currentTarget); if (!t.metaKey && !t.ctrlKey && x.shouldLoadAnchor(e, s.blacklist, s.hrefRegex) && (t.stopPropagation(), t.preventDefault(), !y())) { S(); var n = x.translate(e.prop("href"));
                                 r = !0, o = e.prop("hash"), n = s.alterRequest(n), s.onBefore(e, l), a(n) } },
                         m = function(t) { var e = b(t.currentTarget); if (!e.is(s.blacklist) && (t.preventDefault(), t.stopPropagation(), !y())) { S(); var n = { url: e.prop("action"), data: e.serialize(), type: e.prop("method") };
                                 r = !0, "get" === (n = s.alterRequest(n)).type.toLowerCase() && (n.url = n.url + "?" + n.data), s.onBefore(e, l), a(n, P, s.allowFormCaching) } },
                         v = 0,
                         y = function() { var t = null === s.repeatDelay,
                                 e = parseInt(Date.now()) > v; return !(t || e) },
                         S = function() { v = parseInt(Date.now()) + parseInt(s.repeatDelay) },
                         w = function(t) { s.anchors && s.prefetch && t.find(s.anchors).not(s.prefetchBlacklist).on(s.prefetchOn, null, i) }; return s = b.extend({}, b.fn.smoothState.options, s), null === C.history.state ? (d = s.alterChangeState({ id: c }, E.title, n), C.history.replaceState(d, E.title, n)) : d = {}, x.storePageIn(u, n, E.documentElement.outerHTML, c, d), x.triggerAllAnimationEndEvent(l, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), e = l, s.anchors && (e.on("click", s.anchors, g), w(e)), s.forms && e.on("submit", s.forms, m), { href: n, cache: u, clear: f, load: a, fetch: h, restartCSSAnimations: function() { var t = l.prop("class");
                             l.removeClass(t), x.redraw(l), l.addClass(t) } } };
             C.onpopstate = function(t) { if (b("body").addClass("back-pressed"), setTimeout(function() { b("body").removeClass("back-pressed") }, 550), null !== t.state) { var e = C.location.href,
                         n = b("#" + t.state.id).data("smoothState"),
                         o = n.href !== e && !x.isHash(e, n.href),
                         r = t.state !== n.cache[n.href].state;
                     (o || r) && (r && n.clear(n.href), n.load(e, !1)) } }, b.smoothStateUtility = x, b.fn.smoothState = function(e) { return this.each(function() { var t = this.tagName.toLowerCase();
                     this.id && "body" !== t && "html" !== t && !b.data(this, "smoothState") ? b.data(this, "smoothState", new n(this, e)) : !this.id && O ? O.warn("Every smoothState container needs an id but the following one does not have one:", this) : "body" !== t && "html" !== t || !O || O.warn("The smoothstate container cannot be the " + this.tagName + " tag") }) }, b.fn.smoothState.options = { debug: !1, anchors: "a", hrefRegex: "", forms: "form", allowFormCaching: !1, repeatDelay: 500, blacklist: ".no-smoothState", prefetch: !1, prefetchOn: "mouseover touchstart", prefetchBlacklist: ".no-prefetch", locationHeader: "X-SmoothState-Location", cacheLength: 0, loadingClass: "is-loading", scroll: !1, alterRequest: function(t) { return t }, alterChangeState: function(t, e, n) { return t }, onBefore: function(t, e) {}, onStart: { duration: 0, render: function(t) {} }, onProgress: { duration: 0, render: function(t) {} }, onReady: { duration: 0, render: function(t, e) { t.html(e) } }, onAfter: function(t, e) {} } } });
 }(jQuery));
 ...
 (function($) {
     ...
     ! function(t, s, e, i) { "use strict";

         function n(s, e) { this.element = s, this.settings = t.extend({}, a, e), this._defaults = a, this._name = o, this.init() } var o = "openingTimes",
             a = { openString: "", closedString: "", openClass: "open", closedClass: "closed", openingTimes: {} };
         t.extend(n.prototype, { init: function() { this.weekdays = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], this.date = new Date, this.current_day = this.weekdays[this.date.getDay()], this.current_hour = this.date.getHours(), this.current_minute = this.date.getMinutes(), this.place_is_open = !1, this.hoursForToday = this.settings.openingTimes[this.current_day], "object" == typeof this.hoursForToday ? 2 == this.hoursForToday.length && (this.open_unix_time_today = this.timeStringToDate(this.hoursForToday[0]), this.close_unix_time_today = this.timeStringToDate(this.hoursForToday[1]), this.date <= this.close_unix_time_today && this.date >= this.open_unix_time_today && (this.place_is_open = !0)) : !0 === this.hoursForToday && (this.place_is_open = !0), this.place_is_open ? t(this.element).append(this.settings.openString).addClass(this.settings.openClass) : t(this.element).append(this.settings.closedString).addClass(this.settings.closedClass) }, timeStringToDate: function(t) { var s = new Date,
                     e = t.split(":")[0],
                     i = t.split(":")[1]; return s.setHours(e, i, 0, 0) } }), t.fn[o] = function(s) { return this.each(function() { t.data(this, "plugin_" + o) || t.data(this, "plugin_" + o, new n(this, s)) }) } }(jQuery, window, document);
 }(jQuery));
 ...
 (function($) {
     ...
     ! function(e) { "function" == typeof define && define.amd ? define(["jquery", "hammerjs"], e) : "object" == typeof exports ? e(require("jquery"), require("hammerjs")) : e(jQuery, Hammer) }(function(n, a) { var r;
         n.fn.hammer = function(r) { return this.each(function() { var e, t;
                 e = r, (t = n(this)).data("hammer") || t.data("hammer", new a(t[0], e)) }) }, a.Manager.prototype.emit = (r = a.Manager.prototype.emit, function(e, t) { r.call(this, e, t), n(this.element).trigger({ type: e, gesture: t }) }) });
 }(jQuery));
 ...
 (function($) {
     ...
     ! function(t, i) { "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof exports ? module.exports = i(require("jquery")) : t.lightbox = i(t.jQuery) }(this, function(t) {
         function i(i) { this.album = [], this.currentImageIndex = void 0, this.init(), this.options = t.extend({}, this.constructor.defaults), this.option(i) } return i.defaults = { albumLabel: "Image %1 of %2", alwaysShowNavOnTouchDevices: !1, fadeDuration: 300, fitImagesInViewport: !0, imageFadeDuration: 0, positionFromTop: 50, resizeDuration: 0, showImageNumberLabel: !0, wrapAround: !1, disableScrolling: !1, sanitizeTitle: !1 }, i.prototype.option = function(i) { t.extend(this.options, i) }, i.prototype.imageCountLabel = function(t, i) { return this.options.albumLabel.replace(/%1/g, t).replace(/%2/g, i) }, i.prototype.init = function() { var i = this;
             ...
             function h() { e.$lightbox.find(".lb-dataContainer").width(o), e.$lightbox.find(".lb-prevLink").height(s), e.$lightbox.find(".lb-nextLink").height(s), e.showImage() }
             ...
             this.$lightbox.find(".lb-nav").show(), this.album.length > 1 && (this.options.wrapAround ? (t && this.$lightbox.find(".lb-prev, .lb-next").css("opacity", "1"), this.$lightbox.find(".lb-prev, .lb-next").show()) : (this.currentImageIndex > 0 && (this.$lightbox.find(".lb-prev").show(), t && this.$lightbox.find(".lb-prev").css("opacity", "1")), this.currentImageIndex < this.album.length - 1 && (this.$lightbox.find(".lb-next").show(), t && this.$lightbox.find(".lb-next").css("opacity", "1")))) }, i.prototype.updateDetails = function() { if (void 0 !== this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) { var i = this.$lightbox.find(".lb-caption");
                 this.options.sanitizeTitle ? i.text(this.album[this.currentImageIndex].title) : i.html(this.album[this.currentImageIndex].title), i.fadeIn("fast").find("a").on("click", function(i) { void 0 !== t(this).attr("target") ? window.open(t(this).attr("href"), t(this).attr("target")) : location.href = t(this).attr("href") }) } if (this.album.length > 1 && this.options.showImageNumberLabel) { var e = this.imageCountLabel(this.currentImageIndex + 1, this.album.length);
                 this.$lightbox.find(".lb-number").text(e).fadeIn("fast") } else this.$lightbox.find(".lb-number").hide();
             this.$outerContainer.removeClass("animating") }, i.prototype.preloadNeighboringImages = function() { this.album.length > this.currentImageIndex + 1 && ((new Image).src = this.album[this.currentImageIndex + 1].link);
