...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', function() {
        navigator.serviceWorker.register('front/_service-worker.js', { scope: '/front/' });
    });
}
...
$(document).ready(function() {
    ...
    function check_version() {
        if ($('link[data-pwa-version]').length) {
            function versionCheck() {
                ...
                var onlineVersionJSON = "assets/_manifest.json?ver=" + maniTimeVersion;
    ...
    if (navigator.onLine) { check_version(); } else {
        function check_version() {}
    }
