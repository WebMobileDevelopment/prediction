...
$(document).ready(function() {
    ...
    function init_template() {
        ...
        $('.input-required input[type="text"]').on('focusout', function() { if (nameValidator.test($(this).val())) { $(this).parent().find('em').html(validIcon); } else { if ($(this).val() === "") { $(this).parent().find('em').html("(required)"); } else { $(this).parent().find('em').html(invalidIcon); } } });
    ...
    if (isPWA === true) {
        ...
        function loadPWA() {}
        loadJS('front/scripts/pwa.js', loadPWA, document.body);
    }
});